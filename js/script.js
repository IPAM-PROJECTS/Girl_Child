const speakers = {
  speaker1: {
    ...
    about:
      "Fawaz discovered The Girl pinin 4 beteh organization in 2015. He studied Applied Accounting in the Institute of Public Administration and Management(IPAM) University.",
  ...
  speaker2: {
    ...
    about:
      "She has a Bachelor of Arts degree in journalism at the University of the Arts, London College of Communication,",
    checkersImage: "../images/checkers.png",
  ...
  speaker3: {
    ...
    about:
      "Student at Institute of Public Administration and Management(IPAM) University studying Applied Accounting ",
    checkersImage: "../images/checkers.png",
  ...
  speaker4: {
    ...
    about: "She is a student of Frobay College (FBC) she has a charity foundation to sponsor the less privilege to go school.",
    checkersImage: "../images/checkers.png",
    featuredImage: "../images/sunkF.jpg",
  },
  speaker5: {
    id: 5,
    ...
    about:
      "Studied social works in University of Milton margai. Currently the CEO of kids happiness foundation in Sierra Leone .",
    checkersImage: "../images/checkers.png",
  ...
  speaker6: {
    ...
    about:
      "Saibatu mansaray. is a former White House senior executive, a physician assistant, CEO and Founder of The Mansaray Foundation, a Muslimah.    ",
    checkersImage: "../images/checkers.png",
    featuredImage: "../images/saibatu.jpg",
  },
};
